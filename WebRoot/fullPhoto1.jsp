...
response.sendRedirect("Login.jsp");
 ...
 %>
<%
Integer photoId=(Integer)request.getAttribute("photoId");
Photo photo=photoDao.selectPhoto1(photoId);
List list=pCommentDao.selectpComment(photoId);
 %>
<!doctype html>
<html>
<head>
...
pComment comment=(pComment)list.get(i);
String a=comment.getfName();
System.out.println(a);
 %>
	   <table width="345"  border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#000000">
        ...
        <input type="button" onclick="location='preply.jsp?commentId=<%=comment.getPhotoId() %>&pCommentId=<%=comment.getpCommentId()%>'"  value="回复">
      </table>
	  <%} %>

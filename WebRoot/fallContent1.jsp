...
<jsp:useBean id="article" class="DataBean.Article"></jsp:useBean>
...
response.sendRedirect("Login.jsp");
 ...
 List photoList=photoDao.selectPhoto4(articleId);
  %>
<%
Integer articleId1=(Integer)request.getAttribute("articleId");
 article=articleDao.queryArticle(articleId1);
 %>
<!doctype html>
<html>
<head>
...
Comment comment=(Comment)list.get(i);
 %>
	  ...
	  <table width="261"  border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#000000">
       ...
       <tr>
          <td bgcolor="#FFFFFF">评&nbsp;论&nbsp;人：</td>
          <td bgcolor="#FFFFFF"><input name="articleId" type="hidden" size="26" value="<%=article.getArticleId()%>"><input name="fName" type="hidden" size="26" value="<%=username%>"><%=username%></td>
        </tr>
      </table>

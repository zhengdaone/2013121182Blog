...
if(str==null){
	articleList=articleDao.selectArticle();
...
%>
 <h1 class="t_nav"><a href="/2013121182Blog/allContent1.jsp?articleId=<%=article.getArticleId()%>" class="n2"><%=article.getTitle() %></a></h1> 

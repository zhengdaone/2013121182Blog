...
public class Pagination {
	...
	public String printCtrl2(int Page,int friendId){
		String strHtml="<table width='370'  border='0' cellspacing='0' cellpadding='0'><tr> <td height='24' align='right'>当前页数：["+Page+"/"+maxPage+"]&nbsp;&nbsp;";
		try{
		if(Page>1){
			strHtml=strHtml+"<a href='?Page=1'>第一页</a>　";
			strHtml=strHtml+"&nbsp;&nbsp;<a href='?Page="+(Page-1)+"&friendId="+friendId+"'>上一页</a>";
		}
		if(Page<maxPage){
			strHtml=strHtml+"&nbsp;&nbsp;<a href='?Page="+(Page+1)+"&friendId="+friendId+"'>下一页</a>&nbsp;&nbsp;　<a href='?Page="+maxPage+"'>最后一页&nbsp;</a>";
		}
		strHtml=strHtml+"</td> </tr>	</table>";
		}catch(Exception e){
			e.printStackTrace();
